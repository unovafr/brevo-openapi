...
# Unit tests for Brevo::CrmTasksPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Brevo::CrmTasksPostRequest do
  let(:instance) { Brevo::CrmTasksPostRequest.new }

  describe 'test an instance of CrmTasksPostRequest' do
    it 'should create an instance of CrmTasksPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Brevo::CrmTasksPostRequest)
    end
  end
