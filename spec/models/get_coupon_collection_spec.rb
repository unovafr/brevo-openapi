...
describe Brevo::GetCouponCollection do
  let(:instance) { Brevo::GetCouponCollection.new }
  ...
  describe 'test attribute "total_coupons"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "remaining_coupons"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
