...
# Unit tests for Brevo::CreatePaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Brevo::CreatePaymentRequest do
  let(:instance) { Brevo::CreatePaymentRequest.new }

  describe 'test an instance of CreatePaymentRequest' do
    it 'should create an instance of CreatePaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Brevo::CreatePaymentRequest)
    end
  end
