...
describe Brevo::SubAccountDetailsResponsePlanInfoCredits do
  let(:instance) { Brevo::SubAccountDetailsResponsePlanInfoCredits.new }
  ...
  describe 'test attribute "wp_subscribers"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
