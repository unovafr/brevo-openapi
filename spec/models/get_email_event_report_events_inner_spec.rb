...
# Unit tests for Brevo::GetEmailEventReportEventsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Brevo::GetEmailEventReportEventsInner do
  let(:instance) { Brevo::GetEmailEventReportEventsInner.new }

  describe 'test an instance of GetEmailEventReportEventsInner' do
    it 'should create an instance of GetEmailEventReportEventsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Brevo::GetEmailEventReportEventsInner)
    end
  end
