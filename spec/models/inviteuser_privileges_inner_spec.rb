...
# Unit tests for Brevo::InviteuserPrivilegesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Brevo::InviteuserPrivilegesInner do
  let(:instance) { Brevo::InviteuserPrivilegesInner.new }

  describe 'test an instance of InviteuserPrivilegesInner' do
    it 'should create an instance of InviteuserPrivilegesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Brevo::InviteuserPrivilegesInner)
    end
  end
