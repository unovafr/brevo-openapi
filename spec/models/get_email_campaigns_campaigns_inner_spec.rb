...
# Unit tests for Brevo::GetEmailCampaignsCampaignsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Brevo::GetEmailCampaignsCampaignsInner do
  let(:instance) { Brevo::GetEmailCampaignsCampaignsInner.new }

  describe 'test an instance of GetEmailCampaignsCampaignsInner' do
    it 'should create an instance of GetEmailCampaignsCampaignsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Brevo::GetEmailCampaignsCampaignsInner)
    end
  end
