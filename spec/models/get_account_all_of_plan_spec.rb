...
# Unit tests for Brevo::GetAccountAllOfPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Brevo::GetAccountAllOfPlan do
  let(:instance) { Brevo::GetAccountAllOfPlan.new }

  describe 'test an instance of GetAccountAllOfPlan' do
    it 'should create an instance of GetAccountAllOfPlan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Brevo::GetAccountAllOfPlan)
    end
  end
