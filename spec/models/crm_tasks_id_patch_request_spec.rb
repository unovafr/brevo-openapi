...
# Unit tests for Brevo::CrmTasksIdPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Brevo::CrmTasksIdPatchRequest do
  let(:instance) { Brevo::CrmTasksIdPatchRequest.new }

  describe 'test an instance of CrmTasksIdPatchRequest' do
    it 'should create an instance of CrmTasksIdPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Brevo::CrmTasksIdPatchRequest)
    end
  end
