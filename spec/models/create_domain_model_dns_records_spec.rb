...
describe Brevo::CreateDomainModelDnsRecords do
  let(:instance) { Brevo::CreateDomainModelDnsRecords.new }
  ...
  describe 'test attribute "brevo_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "dmarc_record"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
