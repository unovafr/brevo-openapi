...
describe 'CouponsApi' do
  ...
  describe 'test an instance of CouponsApi' do
    it 'should create an instance of CouponsApi' do
      expect(@api_instance).to be_instance_of(Brevo::CouponsApi)
    end
  end

  # unit tests for create_coupon_collection
  # Create а coupon collection
  # @param create_coupon_collection_request Values to create a coupon collection
  ...
  # @param create_coupons_request Values to create coupons
  # @param [Hash] opts the optional parameters
  # @return [nil]
