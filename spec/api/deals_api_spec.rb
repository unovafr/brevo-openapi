...
describe 'DealsApi' do
  ...
  describe 'test an instance of DealsApi' do
    it 'should create an instance of DealsApi' do
      expect(@api_instance).to be_instance_of(Brevo::DealsApi)
    end
  end
  ...
  # Update a deal
  # @param id 
  # @param crm_deals_id_patch_request Updated deal details.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param id 
  # @param crm_deals_link_unlink_id_patch_request Linked / Unlinked contacts and companies ids.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # Create a deal
  # @param crm_deals_post_request Deal create data.
  # @param [Hash] opts the optional parameters
