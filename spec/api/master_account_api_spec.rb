...
describe 'MasterAccountApi' do
  ...
  describe 'test an instance of MasterAccountApi' do
    it 'should create an instance of MasterAccountApi' do
      expect(@api_instance).to be_instance_of(Brevo::MasterAccountApi)
    end
  end
  ...
  # @param id Id of the group
  # @param corporate_group_id_put_request Group details to be updated.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param corporate_group_unlink_group_id_sub_accounts_put_request List of sub-account ids
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param sub_account_apps_toggle_request List of applications to activate or deactivate on a sub-account
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param id Id of the sub-account organization
  # @param sub_account_update_plan_request Values to update a sub-account plan
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # unit tests for corporate_sub_account_ip_associate_post
  ...
  # @return [Object]
  describe 'corporate_sub_account_ip_associate_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for corporate_sub_account_ip_dissociate_delete
  ...
  # @return [nil]
  describe 'corporate_sub_account_ip_dissociate_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param create_sub_account Request body with sub-account organization name
  # @param [Hash] opts the optional parameters
  ...
  # @param invite_admin_user Payload to send an invitation
  # @param [Hash] opts the optional parameters
  # @return [CorporateGroupPost201Response]
