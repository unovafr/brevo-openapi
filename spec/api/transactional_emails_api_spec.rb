...
describe 'TransactionalEmailsApi' do
  ...
  describe 'test an instance of TransactionalEmailsApi' do
    it 'should create an instance of TransactionalEmailsApi' do
      expect(@api_instance).to be_instance_of(Brevo::TransactionalEmailsApi)
    end
  end
  ...
  # @param block_domain Name of the domain to be blocked
  ...
  # @param create_smtp_template values to update in transactional email template
  # @param [Hash] opts the optional parameters
  # @return [CreateModel]
  ...
  # unit tests for get_scheduled_email_by_id
  ...
  # @option opts [String] :sort Sort the results in the ascending/descending order of record creation. Default order is **descending** if &#x60;sort&#x60; is not passed. Not valid when identifier is &#x60;messageId&#x60;.
  ...
  # @option opts [Integer] :limit Number of documents returned per page. Not valid when identifier is &#x60;messageId&#x60;.
  # @option opts [Integer] :offset Index of the first document on the page.  Not valid when identifier is &#x60;messageId&#x60;.
  # @return [GetScheduledEmailById200Response]
  describe 'get_scheduled_email_by_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param template_id id of the template
  # @param update_smtp_template values to update in transactional email template
  # @param [Hash] opts the optional parameters
  # @return [nil]
