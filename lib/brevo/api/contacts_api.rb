...
module Brevo
  class ContactsApi
    ...
    # @param contact_emails [AddContactToList] Emails addresses of the contacts
    ...
    # Delete a contact
    # @param email [String] Email (urlencoded) of the contact
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    # @param email [String] Email (urlencoded) of the contact OR its SMS attribute value
    # @param [Hash] opts the optional parameters
    ...
    # @param email [String] Email address (urlencoded) of the contact
    # @param [Hash] opts the optional parameters
    ...
    def get_contact_stats_with_http_info(email, opts = {})
      ...
      # resource path
      local_var_path = '/contacts/{email}/campaignStats'.sub('{' + 'email' + '}', CGI.escape(email.to_s))
    ...
    # @option opts [Time] :created_since Filter (urlencoded) the contacts created after a given UTC date-time (YYYY-MM-DDTHH:mm:ss.SSSZ). Prefer to pass your timezone in date-time format for accurate result.
    ...
    # @param request_contact_import [RequestContactImport] Values to import contacts in Sendinblue. To know more about the expected format, please have a look at &#x60;&#x60;https://help.sendinblue.com/hc/en-us/articles/209499265-Build-contacts-lists-for-your-email-marketing-campaigns&#x60;&#x60;
    # @param [Hash] opts the optional parameters
    ...
    # @param list_id [Integer] Id of the list
    # @param contact_emails [RemoveContactFromList] Emails adresses of the contact
    # @param [Hash] opts the optional parameters
    # @return [PostContactInfo]
