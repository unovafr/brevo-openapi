  ...
  class NotesApi
    ...
    def crm_notes_get_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"NotesApi.crm_notes_get",
    ...
    # Delete a note
    # @param id [String] Note ID to delete
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def crm_notes_id_delete_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/crm/notes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"NotesApi.crm_notes_id_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # Get a note
    # @param id [String] Note ID to get
    # @param [Hash] opts the optional parameters
    # @return [Note]
    ...
    def crm_notes_id_get_with_http_info(id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"NotesApi.crm_notes_id_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # Update a note
    # @param id [String] Note ID to update
    # @param note_data [NoteData] Note data to update a note.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def crm_notes_id_patch(id, note_data, opts = {})
      crm_notes_id_patch_with_http_info(id, note_data, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def crm_notes_id_patch_with_http_info(id, note_data, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && note_data.nil?
        fail ArgumentError, "Missing the required parameter 'note_data' when calling NotesApi.crm_notes_id_patch"
      end
      # resource path
      local_var_path = '/crm/notes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"NotesApi.crm_notes_id_patch",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # Create a note
    # @param note_data [NoteData] Note data to create a note.
    # @param [Hash] opts the optional parameters
    # @return [NoteId]
    def crm_notes_post(note_data, opts = {})
      data, _status_code, _headers = crm_notes_post_with_http_info(note_data, opts)
      data
    end
    ...
    # @param note_data [NoteData] Note data to create a note.
    # @param [Hash] opts the optional parameters
    # @return [Array<(NoteId, Integer, Hash)>] NoteId data, response status code and response headers
    def crm_notes_post_with_http_info(note_data, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NotesApi.crm_notes_post ...'
      end
      # verify the required parameter 'note_data' is set
      if @api_client.config.client_side_validation && note_data.nil?
        fail ArgumentError, "Missing the required parameter 'note_data' when calling NotesApi.crm_notes_post"
      end
      # resource path
      local_var_path = '/crm/notes'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'NoteId'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"NotesApi.crm_notes_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
