...
module Brevo
  class DomainsApi
    ...
    # @param domain_name [String] Domain name
    # @param [Hash] opts the optional parameters
    # @return [Array<(AuthenticateDomainModel, Integer, Hash)>] AuthenticateDomainModel data, response status code and response headers
    def authenticate_domain_with_http_info(domain_name, opts = {})
      ...
      # resource path
      local_var_path = '/senders/domains/{domainName}/authenticate'.sub('{' + 'domainName' + '}', CGI.escape(domain_name.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AuthenticateDomainModel'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"DomainsApi.authenticate_domain",
    ...
    # Create a new domain
    # @param [Hash] opts the optional parameters
    # @option opts [CreateDomain] :domain domain&#39;s name
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [CreateDomain] :domain domain&#39;s name
    # @return [Array<(CreateDomainModel, Integer, Hash)>] CreateDomainModel data, response status code and response headers
    def create_domain_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateDomainModel'
    ...
    def delete_domain_with_http_info(domain_name, opts = {})
      ...
      # resource path
      local_var_path = '/senders/domains/{domainName}'.sub('{' + 'domainName' + '}', CGI.escape(domain_name.to_s))
    ...
    # @param domain_name [String] Domain name
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDomainConfigurationModel, Integer, Hash)>] GetDomainConfigurationModel data, response status code and response headers
    def get_domain_configuration_with_http_info(domain_name, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetDomainConfigurationModel'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"DomainsApi.get_domain_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # Get the list of all your domains
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDomainsList, Integer, Hash)>] GetDomainsList data, response status code and response headers
    def get_domains_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetDomainsList'
