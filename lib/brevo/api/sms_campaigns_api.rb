...
module Brevo
  class SMSCampaignsApi
    ...
    # @param campaign_id [Integer] Id of the SMS campaign
    # @param send_test_sms [SendTestSms] Mobile number of the recipient with the country code. This number **must belong to one of your contacts in Brevo account and must not be blacklisted** 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def send_test_sms_with_http_info(campaign_id, send_test_sms, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(send_test_sms)
