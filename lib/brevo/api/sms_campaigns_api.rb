...
module Brevo
  class SMSCampaignsApi
    ...
    # @param create_sms_campaign [CreateSmsCampaign] Values to create an SMS Campaign
    ...
    def create_sms_campaign_with_http_info(create_sms_campaign, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.create_sms_campaign",
    ...
    # @param campaign_id [Integer] id of the SMS campaign
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def delete_sms_campaign_with_http_info(campaign_id, opts = {})
      ...
      # resource path
      local_var_path = '/smsCampaigns/{campaignId}'.sub('{' + 'campaignId' + '}', CGI.escape(campaign_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.delete_sms_campaign",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param campaign_id [Integer] id of the SMS campaign
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetSmsCampaign, Integer, Hash)>] GetSmsCampaign data, response status code and response headers
    def get_sms_campaign_with_http_info(campaign_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetSmsCampaign'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.get_sms_campaign",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [Time] :start_date Mandatory if endDate is used. Starting (urlencoded) UTC date-time (YYYY-MM-DDTHH:mm:ss.SSSZ) to filter the sent sms campaigns. Prefer to pass your timezone in date-time format for accurate result ( only available if either &#39;status&#39; not passed and if passed is set to &#39;sent&#39; )
    # @option opts [Time] :end_date Mandatory if startDate is used. Ending (urlencoded) UTC date-time (YYYY-MM-DDTHH:mm:ss.SSSZ) to filter the sent sms campaigns. Prefer to pass your timezone in date-time format for accurate result ( only available if either &#39;status&#39; not passed and if passed is set to &#39;sent&#39; )
    ...
    # @option opts [Integer] :limit Number limitation for the result returned (default to 500)
    # @option opts [Integer] :offset Beginning point in the list to retrieve from. (default to 0)
    # @return [Array<(GetSmsCampaigns, Integer, Hash)>] GetSmsCampaigns data, response status code and response headers
    def get_sms_campaigns_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetSmsCampaigns'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.get_sms_campaigns",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def request_sms_recipient_export_with_http_info(campaign_id, opts = {})
      ...
      # resource path
      local_var_path = '/smsCampaigns/{campaignId}/exportRecipients'.sub('{' + 'campaignId' + '}', CGI.escape(campaign_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.request_sms_recipient_export",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_sms_campaign_now_with_http_info(campaign_id, opts = {})
      ...
      # resource path
      local_var_path = '/smsCampaigns/{campaignId}/sendNow'.sub('{' + 'campaignId' + '}', CGI.escape(campaign_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.send_sms_campaign_now",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_sms_report_with_http_info(campaign_id, send_report, opts = {})
      ...
      # resource path
      local_var_path = '/smsCampaigns/{campaignId}/sendReport'.sub('{' + 'campaignId' + '}', CGI.escape(campaign_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.send_sms_report",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param campaign_id [Integer] Id of the SMS campaign
    # @param phone_number [SendTestSms] Mobile number of the recipient with the country code. This number must belong to one of your contacts in SendinBlue account and must not be blacklisted
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def send_test_sms_with_http_info(campaign_id, phone_number, opts = {})
      ...
      # resource path
      local_var_path = '/smsCampaigns/{campaignId}/sendTest'.sub('{' + 'campaignId' + '}', CGI.escape(campaign_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(phone_number)
      ...
      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.send_test_sms",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param campaign_id [Integer] id of the SMS campaign
    # @param update_sms_campaign [UpdateSmsCampaign] Values to update an SMS Campaign
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def update_sms_campaign_with_http_info(campaign_id, update_sms_campaign, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_sms_campaign)
    ...
    def update_sms_campaign_status_with_http_info(campaign_id, status, opts = {})
      ...
      # resource path
      local_var_path = '/smsCampaigns/{campaignId}/status'.sub('{' + 'campaignId' + '}', CGI.escape(campaign_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SMSCampaignsApi.update_sms_campaign_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
