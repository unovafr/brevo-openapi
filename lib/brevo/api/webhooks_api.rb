...
module Brevo
  class WebhooksApi
    ...
    # @param export_webhooks_history_request [ExportWebhooksHistoryRequest] Values to submit for webhooks history
    # @param [Hash] opts the optional parameters
    # @return [CreatedProcessId]
    def export_webhooks_history(export_webhooks_history_request, opts = {})
      data, _status_code, _headers = export_webhooks_history_with_http_info(export_webhooks_history_request, opts)
      data
    end
    ...
    def export_webhooks_history_with_http_info(export_webhooks_history_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhooksApi.export_webhooks_history ...'
      end
      # verify the required parameter 'export_webhooks_history_request' is set
      if @api_client.config.client_side_validation && export_webhooks_history_request.nil?
        fail ArgumentError, "Missing the required parameter 'export_webhooks_history_request' when calling WebhooksApi.export_webhooks_history"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(export_webhooks_history_request)
      ...
      new_options = opts.merge(
        :operation => :"WebhooksApi.export_webhooks_history",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_webhooks_with_http_info(opts = {})
      ...
      allowable_values = ["marketing", "transactional", "inbound"]
