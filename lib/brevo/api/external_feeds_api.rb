...
module Brevo
  class ExternalFeedsApi
    ...
    # @param create_external_feed [CreateExternalFeed] Values to create a feed
    ...
    # @param create_external_feed [CreateExternalFeed] Values to create a feed
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateExternalFeed201Response, Integer, Hash)>] CreateExternalFeed201Response data, response status code and response headers
    def create_external_feed_with_http_info(create_external_feed, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_external_feed)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateExternalFeed201Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"ExternalFeedsApi.create_external_feed",
    ...
    # @param uuid [String] UUID of the feed to delete
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def delete_external_feed_with_http_info(uuid, opts = {})
      ...
      # resource path
      local_var_path = '/feeds/{uuid}'.sub('{' + 'uuid' + '}', CGI.escape(uuid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ExternalFeedsApi.delete_external_feed",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [Integer] :limit Number of documents returned per page. (default to 50)
    # @option opts [Integer] :offset Index of the first document on the page. (default to 0)
    # @return [Array<(GetAllExternalFeeds, Integer, Hash)>] GetAllExternalFeeds data, response status code and response headers
    def get_all_external_feeds_with_http_info(opts = {})
      ...
      allowable_values = ["basic", "token", "noAuth"]
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAllExternalFeeds'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"ExternalFeedsApi.get_all_external_feeds",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param uuid [String] UUID of the feed to fetch
    # @param [Hash] opts the optional parameters
    ...
    # @param uuid [String] UUID of the feed to fetch
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetExternalFeedByUUID, Integer, Hash)>] GetExternalFeedByUUID data, response status code and response headers
    def get_external_feed_by_uuid_with_http_info(uuid, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetExternalFeedByUUID'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"ExternalFeedsApi.get_external_feed_by_uuid",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # This endpoint will update an external feed.
    # @param uuid [String] UUID of the feed to update
    # @param update_external_feed [UpdateExternalFeed] Values to update a feed
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def update_external_feed_with_http_info(uuid, update_external_feed, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_external_feed)
      ...
      new_options = opts.merge(
        :operation => :"ExternalFeedsApi.update_external_feed",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
