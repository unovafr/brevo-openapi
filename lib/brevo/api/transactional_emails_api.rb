...
module Brevo
  class TransactionalEmailsApi
    ...
    # @param block_domain [BlockDomain] Name of the domain to be blocked
    ...
    def block_new_domain_with_http_info(block_domain, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.block_new_domain",
    ...
    # @param create_smtp_template [CreateSmtpTemplate] values to update in transactional email template
    # @param [Hash] opts the optional parameters
    # @return [CreateModel]
    def create_smtp_template(create_smtp_template, opts = {})
      data, _status_code, _headers = create_smtp_template_with_http_info(create_smtp_template, opts)
      data
    end
    ...
    def create_smtp_template_with_http_info(create_smtp_template, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransactionalEmailsApi.create_smtp_template ...'
      end
      # verify the required parameter 'create_smtp_template' is set
      if @api_client.config.client_side_validation && create_smtp_template.nil?
        fail ArgumentError, "Missing the required parameter 'create_smtp_template' when calling TransactionalEmailsApi.create_smtp_template"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_smtp_template)
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.create_smtp_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_blocked_domain_with_http_info(domain, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.delete_blocked_domain",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_hardbounces_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.delete_hardbounces",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param identifier [String] The &#x60;batchId&#x60; of scheduled emails batch (Should be a valid UUIDv4) or the &#x60;messageId&#x60; of scheduled email.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def delete_scheduled_email_by_id_with_http_info(identifier, opts = {})
      ...
      # resource path
      local_var_path = '/smtp/email/{identifier}'.sub('{' + 'identifier' + '}', CGI.escape(identifier.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.delete_scheduled_email_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_smtp_template_with_http_info(template_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.delete_smtp_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_aggregated_smtp_report_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_aggregated_smtp_report",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_blocked_domains_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_blocked_domains",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_email_event_report_with_http_info(opts = {})
      ...
      allowable_values = ["bounces", "hardBounces", "softBounces", "delivered", "spam", "requests", "opened", "clicks", "invalid", "deferred", "blocked", "unsubscribed", "error", "loadedByProxy"]
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_email_event_report",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [String] :sort Sort the results in the ascending/descending order of record creation. Default order is **descending** if &#x60;sort&#x60; is not passed. Not valid when identifier is &#x60;messageId&#x60;. (default to 'desc')
    # @option opts [String] :status Filter the records by &#x60;status&#x60; of the scheduled email batch or message. Not valid when identifier is &#x60;messageId&#x60;.
    # @option opts [Integer] :limit Number of documents returned per page. Not valid when identifier is &#x60;messageId&#x60;. (default to 100)
    # @option opts [Integer] :offset Index of the first document on the page.  Not valid when identifier is &#x60;messageId&#x60;. (default to 0)
    # @return [GetScheduledEmailById200Response]
    def get_scheduled_email_by_id(identifier, opts = {})
      data, _status_code, _headers = get_scheduled_email_by_id_with_http_info(identifier, opts)
      data
    end
    ...
    # @option opts [Integer] :limit Number of documents returned per page. Not valid when identifier is &#x60;messageId&#x60;. (default to 100)
    # @option opts [Integer] :offset Index of the first document on the page.  Not valid when identifier is &#x60;messageId&#x60;. (default to 0)
    # @return [Array<(GetScheduledEmailById200Response, Integer, Hash)>] GetScheduledEmailById200Response data, response status code and response headers
    def get_scheduled_email_by_id_with_http_info(identifier, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransactionalEmailsApi.get_scheduled_email_by_id ...'
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling TransactionalEmailsApi.get_scheduled_email_by_id"
      end
      allowable_values = ["asc", "desc"]
      if @api_client.config.client_side_validation && opts[:'sort'] && !allowable_values.include?(opts[:'sort'])
        fail ArgumentError, "invalid value for \"sort\", must be one of #{allowable_values}"
      end
      allowable_values = ["processed", "inProgress", "queued"]
      if @api_client.config.client_side_validation && opts[:'status'] && !allowable_values.include?(opts[:'status'])
        fail ArgumentError, "invalid value for \"status\", must be one of #{allowable_values}"
      end
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 500
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling TransactionalEmailsApi.get_scheduled_email_by_id, must be smaller than or equal to 500.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 0
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling TransactionalEmailsApi.get_scheduled_email_by_id, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/smtp/emailStatus/{identifier}'.sub('{' + 'identifier' + '}', CGI.escape(identifier.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetScheduledEmailById200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api-key']

      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_scheduled_email_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionalEmailsApi#get_scheduled_email_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_smtp_report_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_smtp_report",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_smtp_template_with_http_info(template_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_smtp_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_smtp_templates_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_smtp_templates",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_transac_blocked_contacts_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_transac_blocked_contacts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_transac_email_content_with_http_info(uuid, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_transac_email_content",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_transac_emails_list_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.get_transac_emails_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_test_template_with_http_info(template_id, send_test_email, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.send_test_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def send_transac_email_with_http_info(send_smtp_email, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.send_transac_email",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def smtp_blocked_contacts_email_delete_with_http_info(email, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.smtp_blocked_contacts_email_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param identifier [String] MessageId or Email of the transactional log(s) to delete
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def smtp_log_identifier_delete_with_http_info(identifier, opts = {})
      ...
      # resource path
      local_var_path = '/smtp/log/{identifier}'.sub('{' + 'identifier' + '}', CGI.escape(identifier.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.smtp_log_identifier_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param template_id [Integer] id of the template
    # @param update_smtp_template [UpdateSmtpTemplate] values to update in transactional email template
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_smtp_template(template_id, update_smtp_template, opts = {})
      update_smtp_template_with_http_info(template_id, update_smtp_template, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_smtp_template_with_http_info(template_id, update_smtp_template, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'update_smtp_template' is set
      if @api_client.config.client_side_validation && update_smtp_template.nil?
        fail ArgumentError, "Missing the required parameter 'update_smtp_template' when calling TransactionalEmailsApi.update_smtp_template"
      end
      # resource path
      local_var_path = '/smtp/templates/{templateId}'.sub('{' + 'templateId' + '}', CGI.escape(template_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_smtp_template)
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.update_smtp_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
