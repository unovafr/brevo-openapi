...
module Brevo
  class CorporateSubAccountSsoTokenPostRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Brevo::CorporateSubAccountSsoTokenPostRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Brevo::CorporateSubAccountSsoTokenPostRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      target_validator = EnumAttributeValidator.new('String', ["automation", "email_campaign", "contacts", "landing_pages", "email_transactional", "senders", "sms_campaign", "sms_transactional"])
    ...
    def target=(target)
      validator = EnumAttributeValidator.new('String', ["automation", "email_campaign", "contacts", "landing_pages", "email_transactional", "senders", "sms_campaign", "sms_transactional"])
