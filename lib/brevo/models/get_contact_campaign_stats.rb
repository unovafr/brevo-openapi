...
module Brevo
  ...
  class GetContactCampaignStats
    ...
    def self.openapi_types
      {
        :'messages_sent' => :'Array<GetExtendedContactDetailsAllOfStatisticsMessagesSent>',
        :'hard_bounces' => :'Array<GetExtendedContactDetailsAllOfStatisticsMessagesSent>',
        :'soft_bounces' => :'Array<GetExtendedContactDetailsAllOfStatisticsMessagesSent>',
        ...
        :'transac_attributes' => :'Array<GetContactCampaignStatsTransacAttributesInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Brevo::GetContactCampaignStats` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Brevo::GetContactCampaignStats`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'messages_sent')
        if (value = attributes[:'messages_sent']).is_a?(Array)
          self.messages_sent = value
        end
      end

      if attributes.key?(:'hard_bounces')
        if (value = attributes[:'hard_bounces']).is_a?(Array)
          self.hard_bounces = value
        end
      end

      if attributes.key?(:'soft_bounces')
        if (value = attributes[:'soft_bounces']).is_a?(Array)
      ...
      if attributes.key?(:'transac_attributes')
        if (value = attributes[:'transac_attributes']).is_a?(Array)
