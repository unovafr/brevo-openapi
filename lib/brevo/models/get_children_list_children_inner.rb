  ...
  class GetChildrenListChildrenInner
    ...
    def self.openapi_types
      {
        ...
        :'password' => :'String',
        :'ips' => :'Array<String>',
        :'api_keys' => :'GetChildInfoAllOfApiKeys',
        :'id' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Brevo::GetChildrenListChildrenInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Brevo::GetChildrenListChildrenInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'api_keys')
        self.api_keys = attributes[:'api_keys']
      end
    ...
    def hash
      [email, first_name, last_name, company_name, credits, statistics, password, ips, api_keys, id].hash
    end
