...
module Brevo
  class EcommerceAttributionMetricsConversionSourceConversionSourceIdGet200Response
    ...
    attr_accessor :new_customers_count
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Brevo::EcommerceAttributionMetricsConversionSourceConversionSourceIdGet200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Brevo::EcommerceAttributionMetricsConversionSourceConversionSourceIdGet200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'conversion_source')
        self.conversion_source = attributes[:'conversion_source']
      else
        self.conversion_source = nil
      end

      if attributes.key?(:'orders_count')
        self.orders_count = attributes[:'orders_count']
      else
        self.orders_count = nil
      end
      ...
      if attributes.key?(:'average_basket')
        self.average_basket = attributes[:'average_basket']
      else
        self.average_basket = nil
      end

      if attributes.key?(:'new_customers_count')
        self.new_customers_count = attributes[:'new_customers_count']
      else
        self.new_customers_count = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @new_customers_count.nil?
        invalid_properties.push('invalid value for "new_customers_count", new_customers_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @new_customers_count.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          new_customers_count == o.new_customers_count
    end
    ...
    def hash
      [id, conversion_source, orders_count, revenue, average_basket, new_customers_count].hash
    end
