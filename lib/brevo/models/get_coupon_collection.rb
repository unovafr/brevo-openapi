  ...
  class GetCouponCollection
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Brevo::GetCouponCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Brevo::GetCouponCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_coupons')
        self.total_coupons = attributes[:'total_coupons']
      else
        self.total_coupons = nil
      end

      if attributes.key?(:'remaining_coupons')
        self.remaining_coupons = attributes[:'remaining_coupons']
      else
        self.remaining_coupons = nil
      end
    ...
    def list_invalid_properties
      ...
      if @total_coupons.nil?
        invalid_properties.push('invalid value for "total_coupons", total_coupons cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @total_coupons.nil?
