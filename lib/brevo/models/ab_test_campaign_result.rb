  ...
  class AbTestCampaignResult
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Brevo::AbTestCampaignResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Brevo::AbTestCampaignResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'winning_version')
        self.winning_version = attributes[:'winning_version']
      end

      if attributes.key?(:'winning_criteria')
        self.winning_criteria = attributes[:'winning_criteria']
      end

      if attributes.key?(:'winning_subject_line')
        self.winning_subject_line = attributes[:'winning_subject_line']
      end
      ...
      if attributes.key?(:'winning_version_rate')
        self.winning_version_rate = attributes[:'winning_version_rate']
      end
      ...
      if attributes.key?(:'clicked_links')
        self.clicked_links = attributes[:'clicked_links']
      end
    end
