  ...
  class CrmDealsLinkUnlinkIdPatchRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Brevo::CrmDealsLinkUnlinkIdPatchRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Brevo::CrmDealsLinkUnlinkIdPatchRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'link_contact_ids')
        if (value = attributes[:'link_contact_ids']).is_a?(Array)
          self.link_contact_ids = value
        end
      end

      if attributes.key?(:'unlink_contact_ids')
        if (value = attributes[:'unlink_contact_ids']).is_a?(Array)
          self.unlink_contact_ids = value
        end
      end

      if attributes.key?(:'link_company_ids')
        if (value = attributes[:'link_company_ids']).is_a?(Array)
          self.link_company_ids = value
        end
      end

      if attributes.key?(:'unlink_company_ids')
        if (value = attributes[:'unlink_company_ids']).is_a?(Array)
