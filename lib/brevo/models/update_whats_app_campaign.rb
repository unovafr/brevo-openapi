  ...
  class UpdateWhatsAppCampaign
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Brevo::UpdateWhatsAppCampaign` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Brevo::UpdateWhatsAppCampaign`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'campaign_status')
        ...
        self.campaign_status = 'scheduled'
      end

      if attributes.key?(:'reschedule_for')
        self.reschedule_for = attributes[:'reschedule_for']
      end
    ...
    def valid?
      ...
      campaign_status_validator = EnumAttributeValidator.new('String', ["scheduled", "suspended"])
    ...
    def campaign_status=(campaign_status)
      validator = EnumAttributeValidator.new('String', ["scheduled", "suspended"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reschedule_for == o.reschedule_for &&
    ...
    def hash
      [campaign_name, campaign_status, reschedule_for, recipients].hash
    end
